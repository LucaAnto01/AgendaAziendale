...
namespace AgendaAziendale.Forms.UserControls
{
    public partial class UCLavoratori : UserControl
    {
        ...
        private void UCLavoratori_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ERRORE! UCLavoratori: errore caricamento interfaccia", "UCLavoratori", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Application.Exit();
            }
        }
        ...
        private void DgvLavoratori_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MessageBox.Show("ERRORE! UCLavoratori: errore cell click", "UCLavoratori", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Application.Exit();
            }
        }
        #endregion
        ...
        public void AggiornadgvLavoratori()
        {
            ...
            {
                MessageBox.Show("ERRORE! UCLavoratori: errore aggiornamento dgvlavoratori", "UCLavoratori", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Application.Exit();
            }
